          ...
          while (queue.length !== 0) {
            ...
            for (var _x = point.x - 1; _x <= point.x + 1; _x++) {
              for (var _y = point.y - 1; _y <= point.y + 1; _y++) {
                if (prev.arrayEl[_x] && prev.arrayEl[_x][_y] == prev.currentPlayer && (!arrayVis[_x] || !arrayVis[_x][_y]) && !(_x == p)) {
                  queue.push({
                    x: _x,
                    y: _y
                  });
...
//# sourceMappingURL=index.js.6c94e453b6832de18014.hot-update.js.map