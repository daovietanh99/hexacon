          ...
          while (queue.length !== 0) {
            ...
            for (var x = point.x - 1; x <= point.x + 1; x++) {
              for (var y = point.y - 1; y <= point.y + 1; y++) {
                if (prev.arrayEl[x] && prev.arrayEl[x][y] == prev.currentPlayer && (!arrayVis[x] || !arrayVis[x][y])) {
                  queue.push({
                    x: x,
                    y: y
                  });
                  ...
                  arrayVis[x][y] = true;
                  if (y == 11) console.log("win win win");
                }
              }
            }
          }
...
//# sourceMappingURL=index.js.8373f63443f2b2f032f2.hot-update.js.map