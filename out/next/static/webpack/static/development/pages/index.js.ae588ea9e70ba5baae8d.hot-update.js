        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              for (x = 0; x < 12; x++) {
                if (this.s.currentPlayer === "#0080ff") if (this.s.arrayEl[x] && this.s.arrayEl[x][1] == this.s.currentPlayer) {
                  queue.push({
                    x: x,
                    y: 1
                  });
                  ...
                  arrayVis[x][1] = true;
                } else if (this.s.arrayEl[1] && this.s.arrayEl[1][x] == this.s.currentPlayer) {
                  console.log(this.s.currentPlayer);
                  queue.push({
                    x: 1,
                    y: x
                  });
            ...
            case 13:
              ...
              if (!(this.s.arrayEl[_x] && this.s.arrayEl[_x][y] == this.s.currentPlayer && (!arrayVis[_x] || !arrayVis[_x][y]) && !(_x == point.x - 1 && y == point.y - 1) && !(_x == point.x + 1 && y == point.y + 1))) {
                _context.next = 26;
                break;
              }
              ...
              if (!(y == 11 && this.s.currentPlayer === "#0080ff")) {
                _context.next = 23;
                break;
              }
            ...
            case 23:
              if (!(_x == 11 && this.s.currentPlayer === "#e50000")) {
                _context.next = 26;
                break;
              }
...
//# sourceMappingURL=index.js.ae588ea9e70ba5baae8d.hot-update.js.map