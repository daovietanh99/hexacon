    ...
    value: function play(i, j) {
      if (i !== 0 && j !== 0 && i !== 12 && j !== 12 && !(this.state.arrayEl[i] && this.state.arrayEl[i][j])) {
        this.setState(function (prev) {
          ...
          for (var x = 0; x < 12; x++) {
            if (prev.arrayEl[x] && prev.arrayEl[x][1] == prev.currentPlayer) queue.push({
              x: x,
              y: 1
            });
          }
          ...
          while (queue.length !== 0) {
            ...
            for (var _x = point.x - 1; _x <= point.x + 1; _x++) {
              for (var y = point.y - 1; y <= point.y + 1; y++) {
                if (prev.arrayEl[_x] && prev.arrayEl[_x][y] == prev.currentPlayer && (!arrayVis[_x] || !arrayVis[_x][y])) {
                  queue.push({
                    x: _x,
                    y: y
                  });
...
//# sourceMappingURL=index.js.b25eb93a80ba25c86e6a.hot-update.js.map