          ...
          while (queue.length !== 0) {
            ...
            for (var _x = point.x - 1; _x <= point.x + 1; _x++) {
              for (var _y = point.y - 1; _y <= point.y + 1; _y++) {
                if (prev.arrayEl[_x] && prev.arrayEl[_x][_y] == prev.currentPlayer && (!arrayVis[_x] || !arrayVis[_x][_y]) && !(_x == point.x - 1 && _y == point.x - 1) && !(_x == point.x - 1 && _y == point.x - 1)) {
                  queue.push({
                    x: _x,
                    y: _y
                  });
...
//# sourceMappingURL=index.js.7e012badc8caf6479223.hot-update.js.map