    ...
    value: function play(i, j) {
      if (i !== 0 && j !== 0 && i !== 12 && j !== 12 && !(this.state.arrayEl[i] && this.state.arrayEl[i][j])) {
        this.setState(function (prev) {
          ...
          prev.arrayEl[i][j] = prev.currentPlayer; //check win blue

          var arrayVis = [];
          var queue = [];

          for (var _x = 0; _x < 12; _x++) {
            if (prev.arrayEl[_x] && prev.arrayEl[_x][1] == prev.currentPlayer) {
              queue.push({
                x: _x,
                y: 1
              });
          ...
          while (queue.length !== 0) {
            ...
            for (var _x2 = point.x - 1; _x2 <= point.x + 1; _x2++) {
              for (var y = point.y - 1; y <= point.y + 1; y++) {
                if (prev.arrayEl[_x2] && prev.arrayEl[_x2][y] == prev.currentPlayer && (!arrayVis[_x2] || !arrayVis[_x2][y]) && !(_x2 == point.x - 1 && y == point.y - 1) && !(_x2 == point.x + 1 && y == point.y + 1)) {
                  queue.push({
                    x: _x2,
                    y: y
                  });
                  if (!arrayVis[_x2]) arrayVis[_x2] = [];
                  arrayVis[_x2][y] = true;
          ...
          for (var _y = 0; _y < 12; _y++) {
            if (prev.arrayEl[1] && prev.arrayEl[1][_y] == prev.currentPlayer) {
              queue.push({
                x: 1,
                y: _y
              });
              if (!arrayVis[1]) arrayVis[x] = [];
              arrayVis[x][1] = true;
            }
          }

          while (queue.length !== 0) {
            var _point = queue.pop();

            for (var _x3 = _point.x - 1; _x3 <= _point.x + 1; _x3++) {
              for (var _y2 = _point.y - 1; _y2 <= _point.y + 1; _y2++) {
                if (prev.arrayEl[_x3] && prev.arrayEl[_x3][_y2] == prev.currentPlayer && (!arrayVis[_x3] || !arrayVis[_x3][_y2]) && !(_x3 == _point.x - 1 && _y2 == _point.y - 1) && !(_x3 == _point.x + 1 && _y2 == _point.y + 1)) {
                  queue.push({
                    x: _x3,
                    y: _y2
                  });
                  if (!arrayVis[_x3]) arrayVis[_x3] = [];
                  arrayVis[_x3][_y2] = true;
...
//# sourceMappingURL=index.js.ee2d2202a9795873ff2f.hot-update.js.map