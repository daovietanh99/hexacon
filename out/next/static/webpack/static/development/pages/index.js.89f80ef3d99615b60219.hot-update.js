    ...
    value: function play(i, j) {
      if (i !== 0 && j !== 0 && i !== 12 && j !== 12 && !(this.state.arrayEl[i] && this.state.arrayEl[i][j])) {
        this.setState(function (prev) {
          ...
          for (var x = 1; x <= 11; x++) {
            if (prev.arrayEl[x] && prev.arrayEl[x][1] === prev.currentPlayer) array.push({
              i: x,
              j: 1,
              f: 0
            });
          ...
          while (array.length !== 0) {
            ...
            for (var _x = point.i - 1; _x <= point.i + 1; _x++) {
              for (var y = point.j - 1; y <= point.j + 1; y++) {
                if (!(_x == point.i - 1 && y == point.j - 1 || _x == point.i + 1 && y == point.j + 1 || _x == point.i && y == point.j)) {
                  if (prev.arrayEl[_x] && prev.arrayEl[_x][y] === prev.currentPlayer && (!arrayVal[_x] || arrayVal[_x][y] || arrayVal[_x][y] > point.f + (11 - y))) {
                    array.push({
                      i: _x,
                      j: y,
                      f: point.f + (11 - y)
                    });
                    if (!arrayVal[_x]) arrayVal[_x] = [];
                    arrayVal[_x][y] = point.f + (11 - y);
            ...
            console.table("arrayval======>", arrayVal);
...
//# sourceMappingURL=index.js.89f80ef3d99615b60219.hot-update.js.map