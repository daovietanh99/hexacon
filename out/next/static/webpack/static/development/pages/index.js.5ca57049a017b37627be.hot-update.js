      ...
      if (i !== 0 && j !== 0 && i !== 12 && j !== 12 && !(this.state.arrayEl[i] && this.state.arrayEl[i][j])) {
        this.setState(function (prev) {
          ...
          for (var _x2 = 0; _x2 < 12; _x2++) {
            if (prev.arrayEl[_x2] && prev.arrayEl[_x2][1] == prev.currentPlayer) {
              queue.push({
                x: _x2,
                y: 1
              });
          ...
          while (queue.length !== 0) {
            ...
            for (var _x3 = _point.x - 1; _x3 <= _point.x + 1; _x3++) {
              for (var _y = _point.y - 1; _y <= _point.y + 1; _y++) {
                if (prev.arrayEl[_x3] && prev.arrayEl[_x3][_y] == prev.currentPlayer && (!arrayVis[_x3] || !arrayVis[_x3][_y]) && !(_x3 == _point.x - 1 && _y == _point.y - 1) && !(_x3 == _point.x + 1 && _y == _point.y + 1)) {
                  queue.push({
                    x: _x3,
                    y: _y
                  });
                  if (!arrayVis[_x3]) arrayVis[_x3] = [];
                  arrayVis[_x3][_y] = true;
...
//# sourceMappingURL=index.js.5ca57049a017b37627be.hot-update.js.map