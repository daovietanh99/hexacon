        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              for (x = 0; x < 12; x++) {
                if (this.state.currentPlayer === "#e50000") {
                  if (this.state.arrayEl[x] && this.state.arrayEl[x][1] == this.state.currentPlayer) {
                    queue.push({
                      x: x,
                      y: 1
                    });
            ...
            case 12:
              ...
              if (!(this.state.arrayEl[_x] && this.state.arrayEl[_x][y] == this.state.currentPlayer && (!arrayVis[_x] || !arrayVis[_x][y]) && !(_x == point.x - 1 && y == point.y - 1) && !(_x == point.x + 1 && y == point.y + 1) || _x == i && y == j)) {
                _context.next = 25;
                break;
              }
...
//# sourceMappingURL=index.js.a0493950080b50982644.hot-update.js.map