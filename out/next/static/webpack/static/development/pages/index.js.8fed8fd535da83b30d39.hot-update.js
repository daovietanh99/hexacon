          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(this.setState(function (prev) {
                ...
                for (var x = 0; x < 12; x++) {
                  if (pr.currentPlayer === "#0080ff") {
                    if (pr.arrayEl[x] && pr.arrayEl[x][1] == pr.currentPlayer) {
                      queue.push({
                        x: x,
                        y: 1
                      });
                    ...
                    if (pr.arrayEl[1] && pr.arrayEl[1][x] == pr.currentPlayer) {
                      queue.push({
                        x: 1,
                        y: x
                      });
                ...
                while (queue.length !== 0) {
                  ...
                  for (var _x = point.x - 1; _x <= point.x + 1; _x++) {
                    for (var y = point.y - 1; y <= point.y + 1; y++) {
                      if (pr.arrayEl[_x] && pr.arrayEl[_x][y] == pr.currentPlayer && (!arrayVis[_x] || !arrayVis[_x][y]) && !(_x == point.x - 1 && y == point.y - 1) && !(_x == point.x + 1 && y == point.y + 1)) {
                        queue.push({
                          x: _x,
                          y: y
                        });
                        ...
                        if (y == 11 && pr.currentPlayer === "#e50000") {
                          console.log("win win win");
                          break;
                        } else if (_x == 11 && pr.currentPlayer === "#0080ff") {
                          console.log("win win win");
                          break;
                        }
                      }
...
//# sourceMappingURL=index.js.8fed8fd535da83b30d39.hot-update.js.map