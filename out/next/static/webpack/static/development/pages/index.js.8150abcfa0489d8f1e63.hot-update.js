        ...
        this.setState(function (prev) {
          ...
          for (var x = 0; x < 12; x++) {
            if (prev.currentPlayer === "#0080ff") if (prev.arrayEl[x] && prev.arrayEl[x][1] == prev.currentPlayer) {
              ...
              arrayVis[x][1] = true;
            } else if (prev.arrayEl[1] && prev.arrayEl[1][y] == prev.currentPlayer) {
              queue.push({
                x: 1,
                y: y
              });
          ...
          while (queue.length !== 0) {
            ...
            for (var _x = point.x - 1; _x <= point.x + 1; _x++) {
              for (var _y = point.y - 1; _y <= point.y + 1; _y++) {
                if (prev.arrayEl[_x] && prev.arrayEl[_x][_y] == prev.currentPlayer && (!arrayVis[_x] || !arrayVis[_x][_y]) && !(_x == point.x - 1 && _y == point.y - 1) && !(_x == point.x + 1 && _y == point.y + 1)) {
                  queue.push({
                    x: _x,
                    y: _y
                  });
...
//# sourceMappingURL=index.js.8150abcfa0489d8f1e63.hot-update.js.map