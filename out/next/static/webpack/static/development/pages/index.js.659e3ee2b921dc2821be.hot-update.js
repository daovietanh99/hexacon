          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(this.setState(function (prev) {
                ...
                for (var x = 0; x < 12; x++) {
                  if (_this2.state.currentPlayer === "#0080ff") {
                    if (_this2.state.arrayEl[x] && _this2.state.arrayEl[x][1] == _this2.state.currentPlayer) {
                      queue.push({
                        x: x,
                        y: 1
                      });
                    ...
                    if (_this2.state.arrayEl[1] && _this2.state.arrayEl[1][x] == _this2.state.currentPlayer) {
                      queue.push({
                        x: 1,
                        y: x
                      });
                ...
                while (queue.length !== 0) {
                  ...
                  for (var _x = point.x - 1; _x <= point.x + 1; _x++) {
                    for (var y = point.y - 1; y <= point.y + 1; y++) {
                      if (_this2.state.arrayEl[_x] && _this2.state.arrayEl[_x][y] == _this2.state.currentPlayer && (!arrayVis[_x] || !arrayVis[_x][y]) && !(_x == point.x - 1 && y == point.y - 1) && !(_x == point.x + 1 && y == point.y + 1)) {
                        queue.push({
                          x: _x,
                          y: y
                        });
                        ...
                        if (y == 11 && _this2.state.currentPlayer === "#e50000") {
                          console.log("win win win");
                          break;
                        } else if (_x == 11 && _this2.state.currentPlayer === "#0080ff") {
                          console.log("win win win");
                          break;
                        }
                      }
...
//# sourceMappingURL=index.js.659e3ee2b921dc2821be.hot-update.js.map