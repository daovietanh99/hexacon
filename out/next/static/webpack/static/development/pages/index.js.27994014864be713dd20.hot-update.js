      ...
      if (i !== 0 && j !== 0 && i !== 12 && j !== 12 && !(this.state.arrayEl[i] && this.state.arrayEl[i][j])) {
        this.setState(function (prev) {
          ...
          while (queue.length !== 0) {
            ...
            for (var _x2 = _point.x - 1; _x2 <= _point.x + 1; _x2++) {
              for (var _y2 = _point.y - 1; _y2 <= _point.y + 1; _y2++) {
                if (prev.arrayEl[_x2] && prev.arrayEl[_x2][_y2] == prev.currentPlayer && (!arrayVis[_x2] || !arrayVis[_x2][_y2]) && !(_x2 == _point.x - 1 && _y2 == _point.y - 1) && !(_x2 == _point.x + 1 && _y2 == _point.y + 1)) {
                  queue.push({
                    x: _x2,
                    y: _y2
                  });
                  if (!arrayVis[_x2]) arrayVis[_x2] = [];
                  arrayVis[_x2][_y2] = true;
...
//# sourceMappingURL=index.js.27994014864be713dd20.hot-update.js.map